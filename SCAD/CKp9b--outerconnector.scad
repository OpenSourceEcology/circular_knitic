...
difference(){
            cylinder(h=p9H,d=p3wallID+(p3upperwallW*2)+1);
            
                 rotate([0,0,-((-360/p2number/p2needles)+(1.7*-360/p2number/p2needles))]){
                     cube([(p3wallOD+p9thickness)*2,(p3wallOD+p9thickness)*2,(p3wallOD+p9thickness)*2]);
                 }
...
//end outer holes    
    ...
    rotate([0,270,0])
translate([0,0,0])
cylinder(d=p2p3flatHD,h=p9thickness+p3upperwallW+(p2W+(p3wiggle*2)/2)+p2p3nutH,$fn=36);
