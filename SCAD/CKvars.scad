...
p3basegapWslop=0.25;
p3wallOD=p2OD+p3basegapWslop+(p3wallW*2);
p3wallID=p2OD+p3basegapWslop;   //centerlineD+((p2W+(p3wiggle*2)/2));
...
p4rampW=2; //max(min(p4clawW-3,4),2.5);
...
p7mountholeOD=3;
p7mountholeHeadOD=6.16;  //old 5.68
p7mountnutOD=6.16;       //old 6.01
p7mountnutH=3;
